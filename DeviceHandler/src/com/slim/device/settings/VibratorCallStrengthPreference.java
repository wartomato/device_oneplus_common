...
public class VibratorCallStrengthPreference extends PreferenceFragment implements
	...
	private void setValue(String newValue, boolean withFeedback) {
        ...
        editor.putString(ButtonSettingsFragment.KEY_CALL_VIBSTRENGTH, newValue);
        editor.commit();
	    if (withFeedback) {
    ...
    public static void restore(Context context) {
        ...
        String storedValue = PreferenceManager.getDefaultSharedPreferences(context).getString(ButtonSettingsFragment.KEY_CALL_VIBSTRENGTH, "2088");
